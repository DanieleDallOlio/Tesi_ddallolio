...
Passando alle regole dipendenti, i grafici riportati nella figura \ref{fig:Tdip} mostrano i vari andamenti per la grandezza dei subset.
...
\begin{table}[H]
  ...
  \begin{varwidth}[b]{0.4\linewidth}
	...
	\begin{tabular}{lrrrr}
	\toprule
	{} &         slope & intercetta &     min slope &     max slope \\
	cpu\_type & $\frac{s}{subset}$ & $s$ & $\frac{s}{subset}$ & $\frac{s}{subset}$ \\
	\midrule
	avoton   & \num{9.2e-06} &        6.4 &   \num{9e-06} & \num{9.5e-06} \\
	bio8     & \num{4.4e-06} &        3.1 & \num{4.4e-06} & \num{4.4e-06} \\
	n3700    & \num{9.4e-06} &        7.4 & \num{9.3e-06} & \num{9.5e-06} \\
...
\begin{table}[H]
  ...
  \begin{varwidth}[b]{0.4\linewidth}
	...
	\toprule
	{} &         slope & intercetta &     min slope &     max slope \\
	cpu\_type & $\frac{s}{subset}$ & $s$ & $\frac{s}{subset}$ & $\frac{s}{subset}$ \\			\midrule
	avoton   &   \num{8e-05} &        6.5 & \num{7.9e-05} & \num{8.3e-05} \\
	bio8     & \num{4.3e-05} &        7.9 & \num{4.3e-05} & \num{4.3e-05} \\
	n3700    & \num{8.4e-05} &         12 & \num{8.3e-05} & \num{8.6e-05} \\
	xeond    & \num{5.1e-05} &        2.9 & \num{5.1e-05} & \num{5.1e-05} \\
...
Ciascun gruppo di dati è stato sottoposto a regressione lineare, la quale ha evidenziato come il tempo di esecuzione di ogni regola cresce linearmente rispetto al range del subset.
