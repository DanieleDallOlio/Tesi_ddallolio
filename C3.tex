...
Per ciascuna figura viene anche riportata una tabella con i dettagli delle rigressioni lineari effetuati per descrivere il tempo di esecuzione in funzione del numero di sequenze lette.
...
\begin{table}[H]
  ...
  \begin{varwidth}[b]{0.4\linewidth}
	...
	\text{tipo di cpu} & $\frac{s}{subset}$ & $s$ & $\frac{s}{subset}$ & $\frac{s}{subset}$ \\
	\midrule
	avoton   & \num{9.2e-06} &        6.4 &   \num{9e-06} & \num{9.5e-06} \\
	bio8     & \num{4.4e-06} &        3.1 & \num{4.4e-06} & \num{4.4e-06} \\
	n3700    & \num{9.4e-06} &        7.4 & \num{9.3e-06} & \num{9.5e-06} \\
...
\begin{table}[H]
  ...
  \begin{varwidth}[b]{0.4\linewidth}
	...
	\toprule
	{} &         pendenza & intercetta &     min pendenza &     max pendenza \\
	\text{tipo di cpu} & $\frac{s}{subset}$ & $s$ & $\frac{s}{subset}$ & $\frac{s}{subset}$ \\			\midrule
	avoton   &   \num{8e-05} &        6.5 & \num{7.9e-05} & \num{8.3e-05} \\
	bio8     & \num{4.3e-05} &        7.9 & \num{4.3e-05} & \num{4.3e-05} \\
	n3700    & \num{8.4e-05} &         12 & \num{8.3e-05} & \num{8.6e-05} \\
	xeond    & \num{5.1e-05} &        2.9 & \num{5.1e-05} & \num{5.1e-05} \\
...
\toprule
regola & \multicolumn{2}{l}{build bam} & \multicolumn{2}{l}{mapping} & \multicolumn{2}{l}{mark duplicates} & \multicolumn{2}{l}{realigner} & \multicolumn{2}{l}{sort picard} \\
...
I valori ottenuti evidenziano che la memoria è fortemente stabile in ogni regola per ciascun nodo.
