...
Dalla forma assunta da tale struttura si può osservare che il lavoro degli sviluppatori del DAG è stato basato sulla teoria dei network e che l'applicazione di questa consente una descrizione semplice e compatta del sistema. 
Questa schematizzazione consente anche di visualizzare quali dei lavori sono parallelizzabili e quali, invece, devono mantenere una prestabilita sequenzialità. 
...
La tabella della \ref{fig:Cluster} mostra le macchine utilizzate per i test.
...
$\begin{array}{*{6}{c}}
	...
	\midrule
		...
		bio8 & \text{2x Xeon E5-2620v4} & 128\,GB & 2 TB(HDD) & \text{\euro 10000} & 180W\\		
	\bottomrule
\end{array}$%
}
...
$\begin{array}{*{6}{c}}
	...
	\midrule
		...
		\text{Atom C2750} & Silvermont(Avoton)/22nm & 2.40(2.60) & 8 & 4MB & 25W \\
...
Si sottolinea che, in realtà, il nodo xeond ha una cpu con TDP pari a 45W e quindi è considerato al limite come macchina low power.
