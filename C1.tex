...
La terza sezione descrive l'importanza dei nodi low power e specifica quali tipi di nodi sono stati adoperati nelle analisi.
...
Al contrario, la strategia \textit{push} esegue un procedimento a partire dai contenuti iniziali, attivando i compito successivi una volta svolte le operazioni(modello \textit{"a monte"}). 
