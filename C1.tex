...
\textbf{Essa deriva dal fatto che il metodo Sanger, per via dell'alta precisione, ha ottenuto l'intero genoma umano in circa tredici anni per un investimento economico massiccio.} 
